  ...
  return (
    <div>
     <button className="group relative overflow-hidden rounded-3xl border border-white/50 p-8 transition-all duration-500 hover:scale-[1.02] min-h-[200px] w-[200px]">
      <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 to-yellow-600 opacity-95 transition-opacity duration-500 group-hover:opacity-70" />
      <div
        className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 from-yellow-200 to-yellow-300 blur-3xl"
